...
import edu.zjnu.weChat.utils.enums.VerifyFriendEnum;
...
public class MessageTools {
    ...
    private static WxHttpClient wxHttpClient = core.getMyHttpClient();
    ...
    private static JSONObject webWxUploadMedia(String filePath) {
        ...
        String webwxDataTicket = WxHttpClient.getCookie("webwx_data_ticket");
        ...
        HttpEntity entity = wxHttpClient.doPostFile(url, reqEntity);
        if (entity != null) {
            try {
