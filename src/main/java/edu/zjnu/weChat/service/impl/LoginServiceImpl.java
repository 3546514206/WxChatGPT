package edu.zjnu.weChat.service.impl;
...
import edu.zjnu.weChat.utils.Config;
import edu.zjnu.weChat.utils.WxHttpClient;
import edu.zjnu.weChat.utils.SleepUtils;
import edu.zjnu.weChat.utils.enums.ResultEnum;
import edu.zjnu.weChat.utils.enums.RetCodeEnum;
import edu.zjnu.weChat.utils.enums.StorageLoginInfoEnum;
import edu.zjnu.weChat.utils.enums.URLEnum;
import edu.zjnu.weChat.utils.enums.parameters.BaseParaEnum;
import edu.zjnu.weChat.utils.enums.parameters.LoginParaEnum;
import edu.zjnu.weChat.utils.enums.parameters.StatusNotifyParaEnum;
import edu.zjnu.weChat.utils.enums.parameters.UUIDParaEnum;
...
public class LoginServiceImpl implements ILoginService {
    ...
    public boolean getQR(String qrPath) {
        ...
        HttpEntity entity = wxHttpClient.doGet(qrUrl, null, true, null);
        try {
    ...
    private void processLoginInfo(String loginContent) {
        ...
        if (matcher.find()) {
            ...
            try {
                HttpEntity entity = wxHttpClient.doGet(originalUrl, null, false, null);
    ...
    private JSONObject webWxSync() {
        ...
        String paramStr = JSON.toJSONString(paramMap);
        try {
            HttpEntity entity = wxHttpClient.doPost(url, paramStr);
            String text = EntityUtils.toString(entity, Consts.UTF_8);
            JSONObject obj = JSON.parseObject(text);
    ...
    private Map<String, String> syncCheck() {
        ...
        SleepUtils.sleep(7);
        try {
            HttpEntity entity = wxHttpClient.doGet(url, params, true, null);
            if (entity == null) {
